...
const SidebarLeft = ({ children }: { children: ReactNode }) => {
	...
	return (
		<div className=''>
			...
			{/* Mobile footer menu */}
			<div className='flex sticky bottom-0 w-full md:hidden bg-white p-3 h-fit shrink-0 border border-top border-gray-200 justify-center' style={{ marginTop: '220px' }}>
				<div className='flex'>
					{user?.accountType === 'User' && (
						<>
