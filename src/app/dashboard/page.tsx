		...
		<div className="container w-full min-h-screen pb-20">
			...
			<div className="relative">
				...
				<div className="absolute left-0 bottom-[-10px] w-full">
					<svg
						...
						className="w-full h-[20px] text-purple-500"
						fill="currentColor"
					>
						<path
			...
			<div className="grid grid-cols-2 gap-4 mt-6">
				...
				<div className="bg-white shadow-md rounded-md p-6 text-center">
					<h3 className="font-semibold text-xl text-gray-700">Total Earnings</h3>
				...
				{/* Card 2 */}
				<div className="bg-white shadow-md rounded-md p-6 text-center">
					<h3 className="font-semibold text-xl text-gray-700">My Balance</h3>
					<p className="text-gray-500 mt-2">	{toNaira(dashboardData?.myBalance.value ?? 0)}</p>
				</div>
				{/* Card 3 */}
				<div className="bg-white shadow-md rounded-md p-6 text-center">
					<h3 className="font-semibold text-xl text-gray-700">Adverts Created</h3>
					<p className="text-gray-500 mt-2">	<strong className='text-xl md:text-3xl'>
				...
				{/* Card 4 */}
				<div className="bg-white shadow-md rounded-md p-6 text-center">
					<h3 className="font-semibold text-xl text-gray-700">Tasks Completed</h3>
