...
const VerifyAccountOTP = ({accountDetailsData, handleModal, email}) => {
        ...
        <div className='wrapper'>
          ...
          <img src={close} alt="close" onClick={handleModal} size={40} className='absolute top-[-1rem] right-[-1rem] text-tertiary' />
            <div className='mb-5 flex flex-col items-center text-center'>
                ...
                <h3 className='w-full text-xl text-gray-600 font-bold px-6 mt-2'>Please, enter the OTP sent to your registered Email</h3>
            </div>
