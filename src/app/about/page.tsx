			...
			<div className='container h-full flex flex-col justify-center gap-7 mx-auto'>
				...
				<div className='flex flex-col h-full items-center justify-center mx-auto md:flex-row'>
					<div className='flex-1 flex w-full h-full flex-col mt-[3rem] px-[2rem] py-[4rem] gap-3'>
						...
						<p className='w-full text-[20px] leading-8 text-gray-600 mt-3'>
							Belocated is an enterprising publicity and media service provider
							across industries. We are a revolutionizing team of people
							dedicated to providing solutions to your publicity and media
							challenges
						</p>
					</div>
					...
					<div className='flex flex-col items-center justify-center gap-[5rem] mt-[2rem] md:flex-row'>
						...
						<div className='bg-transparent w-fit md:w-[450px] h-[450px] flex flex-col gap-2 items-center justify-center text-center shadow-2xl'>
							...
							<p className='px-6'>
								...
								platform to be seen and with visibility comes the needed sales.
							</p>
						</div>
					</div>
				</div>
				...
				<div className='mt-[5rem]'>
					<h2 className='text-gray-600 px-6 text-[23px] md:text-[38px] mb-[5px] font-bold text-center w-fit'>
						...
						you need to take your business, product or brand to the next level.
					</h2>
					<h3 className='text-secondary text-[18px] mx-[1rem] w-fit md:text-[38px] mb-[1rem] text-center'>
						We are a brand that does the unusual and so we stay outside the box
						to give our clients the very best services.
					</h3>
				</div>
					...
					<div className='flex flex-col w-full items-center gap-2 mt-[2rem] md:flex-row'>
						<div className='bg-gray-100 w-fit md:w-[450px] h-[500px] mx-[1rem] flex flex-col gap-2 items-center justify-center text-center shadow-2xl rounded-2xl'>
							...
							<p className='px-6 text-center'>
								...
								uncountable opportunities out there for you but only if you can
								be located. With BeLocated platform you can access countless
								business and earning opportunities while listing opportunities
								for many others.
							</p>
						...
						<div className='bg-gray-100 w-fit md:w-[450px] h-[500px] mx-[1rem] flex flex-col gap-2 items-center justify-center text-center shadow-2xl rounded-2xl'>
							...
							<p className='px-6 text-center'>
								Increase your business visibility and create awareness for your
								brand and services through our customized publicity plan. With
								Belocated, there is a package for everyone no matter how little
								or how much your budget is. We work with your business goal and
								timeline to provide affordable publicity packages that will get
								you, your brand or your business located
							</p>
						...
						<div className='bg-gray-100 w-fit md:w-[450px] h-[500px] mx-[1rem] flex flex-col gap-2 items-center justify-center text-center shadow-2xl roundedP-2xl'>
							...
							<p className='px-6 text-center'>
								Belocated is more than just a business but an organization that
								rewards you for all transactions carried out on the platform. As
								a client, you earn guaranteed return on your business
								investments, visible results as well as on time and quality
								service delivery. As a user you earn for every task performed on
								the platform. Here, everyone is a WINNER!
							</p>
