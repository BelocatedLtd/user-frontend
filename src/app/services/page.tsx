			...
			<div className='flex flex-col justify-center mx-auto gap-[5rem]'>
				<div className='w-full h-full py-[5rem] mt-[5rem] flex flex-col items-center justify-center mx-auto'>
					...
					<p className='flex text-[18px] text-center mx-[1rem] w-fit md:w-[800px] text-gray-600 leading-[1.5]'>
						We reward our Clients/Advertisers with good services while upholding
						all our core values. As a ‘people-first’ brand, here are some
						carefully curated services offered by BeLocated
					</p>
				</div>
