  ...
  return (
    <section className='w-full h-fit'>
        <div className='container flex flex-col items-center mx-auto leading-[1.2]'>
            ...
            <h3 className='text-secondary text-[18px] md:text-[38px] mb-[1rem] text-center'>Quae Fuga Obcaecati Numquam Quidem.</h3>
            <p className='flex text-[18px] text-center w-[500px] md:w-[700px] text-gray-600 leading-[1.5]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat architecto dolore vitae quos, saepe ex similique molestias, provident sunt ea soluta, nemo aspernatur.</p>
