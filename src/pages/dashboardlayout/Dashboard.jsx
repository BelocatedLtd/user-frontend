			...
			<div className='justify-between mx-auto md:mr-3'>
				<div className='flex mb-10 items-center justify-between'>
					...
					<div className='space-x-2 '>
						<button className='text-sm bg-secondary text-white px-4 py-2 rounded-lg'>
							Earn
						</button>
						<button className='text-sm bg-tertiary text-white px-4 py-2 rounded-lg'>
							Advertise
						</button>
						<button className='text-sm bg-gray-600 text-white px-4 py-2 rounded-lg'>
							Refer
						</button>
					</div>
				</div>
