		...
		<div className='box p-6 shadow-lg'>
			...
			<form onSubmit={handleSubmit}>
				...
				<div className='flex flex-col mt-6 gap-6'>
					...
					<div className=''>
						<label htmlFor='bank account name' className='text-left mb-1 ml-1'>
							Account Name
						</label>
						<input
							type='text'
					...
					<div className=''>
						<label htmlFor='Account Number' className='text-left mb-1 ml-1'>
							Account Number
						</label>
						<input
							type='number'
