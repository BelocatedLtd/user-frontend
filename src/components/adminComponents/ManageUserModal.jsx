				...
				<div className='w-full h-full modal__header__text flex flex-col items-center justify-center'>
					...
					<form onSubmit={confirm} className='flex flex-col items-center gap-2'>
						<select
							...
							<option value='null' className='bg-gray-900 text-primary'>
								Manage User
							</option>
							<option value='Active' className='bg-gray-900 text-primary'>
								Re-activate User
							</option>
							<option value='Suspended' className='bg-gray-900 text-primary'>
								Suspend User
							</option>
							<option value='Banned' className='bg-gray-900 text-primary'>
								Ban User
							</option>
							<option value='Delete' className='bg-gray-900 text-primary'>
								Delete User
							</option>
						</select>
						<button
							onClick={confirm}
							className='py-2 px-4 mt-3 text-[15px] bg-tertiary text-primary rounded-full'>
							Submit
						</button>
					</form>
				</div>
