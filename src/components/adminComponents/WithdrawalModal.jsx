...
const WithdrawalModal = () => {
	...
	useEffect(() => {
		const wd =
			withdrawalList?.find(
				(wdrequest) => wdrequest?._id === withdrawalRequestId,
			) || {}
			...
			<div className='flex items-center gap-3 border-b border-gray-200 pb-6'>
				...
				<div className='flex flex-col'>
					<p className='font-semibold text-xl text-gray-700'>
						Go back to Withdrawal Request List
					</p>
					...
					<div className='flex flex-col justify-center items-center md:p-[3rem] gap-2'>
						<div className='withdraw__method w-full flex-flex-col justify-center text-center mt-[1rem]'>
							<label
								...
								This User would like to be paid by{' '}
							...
							{withdrawMethod === 'airtime' && (
								<div className='flex flex-col justify-center items-center gap-5 mt-[1rem]'>
									<label htmlFor='fund account' className='font-bold text-sm'>
										{`Send ₦${withdrawAmount} airtime to:`}{' '}
									</label>
							...
							{withdrawMethod === 'bank transfer' && (
								<div className='flex flex-col justify-center items-center gap-2 mt-[1rem]'>
									<label
										htmlFor='fund account'
										className='font-bold text-sm'>{`You will transfer the sum of ₦${withdrawAmount} to this bank account details below:`}</label>
						...
						<div className='flex flex-col md:flex-row items-center'>
							...
							<button
								...
								className='bg-tertiary text-gray-100 px-6 py-1 mt-5'>
								<>
									{!isLoading && 'Delete'}
									{isLoading && 'Deleting...'}
								</>
