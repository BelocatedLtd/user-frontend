	...
	return (
		<section className='h-[70%] text-primary bg-gray-800'>
			<div className='container h-full  mx-auto '>
				...
				<div className='container mt-20 flex flex-col justify-between mx-auto pt-[3rem] pb-[3rem] md:flex-row'>
					<div className='w-full text-gray-600 md:flex md:flex-col'>
						<div className='text-lg text-primary w-[40%]' key='category.id'>
					...
					<div className='flex w-full gap-10 bg-red-'>
						...
						<div className='w-full p-6text-primary'>
							<div className='flex items-center gap-2 mb-6'>
