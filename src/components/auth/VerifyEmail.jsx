...
import { resendVerificationEmail } from '../frontend/src/services/authServices'
...
const VerifyEmail = () => {
	...
	return (
		<div className='w-full h-[88vh] flex items-center justify-center'>
			...
			<div className='w-[350px] md:w-[600px] flex justify-center h-fit bg-primary mx-auto mt-1 py-1]'>
				<div className='w-full h-full flex flex-col justify-center items-center'>
					<h3 className='flex gap-1 text-xl text-gray-800 font-bold px-6 mt-1 items-center'>
					...
					<div className='w-full h-fit px-1 py-1 my-2 flex flex-col items-center'>
						<p className='w-[80%] text-[12px] px-2 text-center'>
							...
							email or send a WhatsApp message to chat with a customer rep.
						</p>
