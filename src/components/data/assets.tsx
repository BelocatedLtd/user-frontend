...
const socialPlatforms = [
    ...
    },
    {
        ...
        assets: [
	     ...
	     {
                asset: 'Join Group/Channel',
                SC: 'Get People To Join Whatsapp Group/Channel.',
                TD: 'Get Paid for Joining Whatsapp Group/Channel',
                verification: 'Take a screenshot of the Group/Channel after joining',
                CostToOrder: 200,
                amountForTask: 150,
            }
        ]
